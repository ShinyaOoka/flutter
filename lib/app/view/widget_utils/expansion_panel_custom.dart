...
///
/// The position of the panel within an [ExpansionPanelListRemovePaddingTopBottom] is given by
/// [panelIndex].
...
/// [ExpansionPanelListRemovePaddingTopBottom].
///
/// See [ExpansionPanelListRemovePaddingTopBottom] for a sample implementation.
///
/// See also:
///
///  * [ExpansionPanelListRemovePaddingTopBottom]
///  * <https://material.io/design/components/lists.html#types>
class ExpansionPanelRemoveTopBottom extends ExpansionPanel{
  /// Creates an expansion panel to be used as a child for [ExpansionPanelListRemovePaddingTopBottom].
  /// See [ExpansionPanelListRemovePaddingTopBottom] for an example on how to use this widget.
  ///
  /// The [headerBuilder], [body], and [isExpanded] arguments must not be null.
  ExpansionPanelRemoveTopBottom({
...
/// This identifier allows the [ExpansionPanelListRemovePaddingTopBottom] to determine
...
/// expansions.
///
/// Note that [expansionCallback] behaves differently for [ExpansionPanelListRemovePaddingTopBottom]
...
///  * <https://material.io/design/components/lists.html#types>
class ExpansionPanelListRemovePaddingTopBottom extends StatefulWidget {
  /// Creates an expansion panel list widget. The [expansionCallback] is
  /// triggered when an expansion panel expand/collapse button is pushed.
  ///
  /// The [children] and [animationDuration] arguments must not be null.
  const ExpansionPanelListRemovePaddingTopBottom({
    Key? key,
  ...
  /// {@end-tool}
  const ExpansionPanelListRemovePaddingTopBottom.radio({
    Key? key,
  ...
  @override
  State<StatefulWidget> createState() => _ExpansionPanelListRemovePaddingTopBottomState();
}

class _ExpansionPanelListRemovePaddingTopBottomState extends State<ExpansionPanelListRemovePaddingTopBottom> {
  ...
  @override
  void didUpdateWidget(ExpansionPanelListRemovePaddingTopBottom oldWidget) {
