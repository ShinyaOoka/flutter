...
const _createReportTable = '''CREATE TABLE ${DBConstants.reportTable} (
  ...
  PlaceOfDispatch VARCHAR(25),
  AccidentSummary VARCHAR(100),	
  ADL VARCHAR(3),
  TrafficAccident_Unknown INTEGER,
  TrafficAccident_Seatbelt INTEGER,
  TrafficAccident_Childseat INTEGER,
  TrafficAccident_Airbag INTEGER,
  TrafficAccident_Helmet INTEGER,
  Witnesses INTEGER,
  BystanderCPR INTEGER,
  BystanderCPRTime STRING,
  ...
  FacialFeatures_Normal VARCHAR,
  FacialFeatures_Flush VARCHAR,
  FacialFeatures_Pale VARCHAR,
  FacialFeatures_Cyanosis VARCHAR,
  FacialFeatures_Diaphoresis VARCHAR,
  ...
  LimitationOfSpinalMotion VARCHAR(3),
  ...
  ReasonForTransfer VARCHAR(3),
  OtherReasonForTransfer VARCHAR(60),
  ReasonForNotTransferring VARCHAR(3),
  OtherReasonForNotTransferring VARCHAR(100),
  RecordOfRefusalOfTransfer INTEGER,
  NameOfReporter VARCHAR(20),
  AffiliationOfReporter	VARCHAR(20),
  PositionOfReporter VARCHAR(3),
