...
class _PreviewReportScreenState extends State<PreviewReportScreen> {
  ...
  String fillCertificateData(String htmlInput) {
    ...
    const String styleCSSMore =
        '.square {display: inline-block;width: 12px;height: 12px;margin-left: 2px;margin-right: 2px;border: 1px black solid; vertical-align: middle}.square-black {display: inline-block;width: 12px;height: 12px;margin-left: 2px;margin-right: 2px;border: 1px black solid;background: black;vertical-align: middle}.text-circle {border-radius: 100%;padding: 2px;background: #fff;border: 1px solid #000;text-align: center}';
